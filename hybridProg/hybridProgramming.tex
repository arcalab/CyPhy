...
\begin{frame}{Pause for Meditations}
        ...
        \begin{center}
        \fbox{
                From our end we will add \alert{differential} operations
        }
        \end{center}
\end{frame}
...
\begin{frame}{ \dots\ its semantics }
        ...
        \textsc{Lince} relies on such a semantics: evaluation of
...
\begin{frame}{Following the leader pt. II}
  ...
  \pause
  \vspace{0.5cm}
  Conditional arises from \alert{solving} the following equation for $t$
  \[
